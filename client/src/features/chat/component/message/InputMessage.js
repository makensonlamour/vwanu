      ...
      <div className="z-40">
        <div className="w-full">
          ...
          <div className="flex items-start py-0 px-2 bg-placeholder-color rounded-t-lg w-full">
            <div className="flex justify-between text-left py-2 lg:py-2 lg:px-2">
              <button
                onClick={() => {
                  if (selectedGif !== "") {
              ...
              <button
                ...
                className="inline-flex justify-center p-2 text-gray-900 rounded-lg cursor-pointer hover:text-primary"
              >
