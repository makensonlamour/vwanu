...
const MediaPreview = ({ photo, imgComponent, sender, type = "photo" }) => {
  ...
  return (
    <>
      ...
      {showModal && (
        <div className="z-50 justify-center flex overflow-x-hidden overflow-y-auto scrollbar inset-0 fixed bg-black bg-opacity-[0.95] h-full w-full outline-none focus:outline-none">
