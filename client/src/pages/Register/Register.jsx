...
const RegisterScreen = () => {
  return (
    <>
      <div className="mx-0 md:mx-0 lg:h-full ">
        <div className="grid grid-cols-1 lg:mb:0 lg:grid-cols-2">
          ...
          >
            <div className="bg-gradient-to-tr from-g-one/[0.78] to-g-two/[0.78] h-96 z-0 lg:h-full">
          ...
          <div className="place-items-center bg-base-100 shadow-t-2xl rounded-t-[30px] lg:rounded-none px-4 md:px-8 -mt-28 z-10 md:mx-36 lg:mt-0 lg:mx-0 lg:h-full">
