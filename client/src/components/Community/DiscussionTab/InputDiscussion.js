...
*/
  return (
    <>
      <Toaster />
      <button onClick={() => setShowModal(true)} className="bg-primary text-white py-2 px-6 border border-gray-200 rounded-lg ml-2">
        New discussion
      </button>
            ...
            <div className="relative w-full my-6 mx-auto max-w-md lg:max-w-2xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between px-5 py-3 border-b border-solid border-blueGray-200 rounded-t">
                  <div className="flex justify-start basis-[80%]">
                    ...
                    <div className="basis-full ml-4">
                      <Field
                        ...
                        className="w-full border-none text-lg focus:shadow-lg placeholder:text-gray-600 font-light"
                      />
                    </div>
                  </div>
