  ...
  return (
    <>
      <div className="form-control">
        ...
        />
        <label htmlFor={id}>
          <div className="absolute border-2 border-white bottom-[25%] right-[17%] xs:bottom-[25%] xs:right-[21%] lg:right-[34%] lg:bottom-[25%] rounded-[14px] bg-gray-300 opacity-75 p-2">
            {icon}
          </div>
        </label>
